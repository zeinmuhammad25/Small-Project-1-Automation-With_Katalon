...
WebUI.click(findTestObject('order_sumarry/button_continue'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('select_payment/button_credit'))

WebUI.setText(findTestObject('credit_debitCard/input_cartNumber'), '12312121')

WebUI.setText(findTestObject('credit_debitCard/input_expireDate'), ' ')

WebUI.setText(findTestObject('credit_debitCard/input_cvv'), '123')
...
WebUI.setText(findTestObject('input_expiryDate'), GlobalVariable.expireDate)

WebUI.setText(findTestObject('credit_debitCard/input_cvv'), GlobalVariable.cvv)

WebUI.click(findTestObject('credit_debitCard/button_payNow'))

WebUI.verifyElementPresent(findTestObject('payment_ticket/button_ok'), 0)
