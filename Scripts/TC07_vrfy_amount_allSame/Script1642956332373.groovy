...
WebUI.setText(findTestObject('shopping_cart/input_harga'), '35000')

harga1 = WebUI.getText(findTestObject('Home/data_hargaBarang'))
...
harga2 = WebUI.getText(findTestObject('shopping_cart/total_harga'))

WebUI.click(findTestObject('shopping_cart/button_checkout'))

harga3 = WebUI.getText(findTestObject('order_sumarry/amount'))

assert(harga1 == harga2 )
assert(harga2 == harga3)
WebUI.closeBrowser()
