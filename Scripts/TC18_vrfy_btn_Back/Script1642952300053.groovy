...
WebUI.click(findTestObject('button_back_credit_debitCard'))

WebUI.verifyElementPresent(findTestObject('select_payment/button_credit'), 0)

WebUI.click(findTestObject('button_back_selectPayment'))

WebUI.verifyElementPresent(findTestObject('order_sumarry/amount'), 0)
