...
name = WebUI.getAttribute(findTestObject('shopping_cart/input_name'), 'value')

System.out.println(name)

WebUI.setText(findTestObject('shopping_cart/input_email'), GlobalVariable.email)

phone = GlobalVariable.phonenumber
...
WebUI.verifyEqual(GlobalVariable.nameShippingDetail, GlobalVariable.nama)

WebUI.verifyEqual(GlobalVariable.emailShippingDetail, GlobalVariable.email)

WebUI.verifyEqual(GlobalVariable.phoneNumberShippingDetail, GlobalVariable.phonenumber)

WebUI.verifyEqual(GlobalVariable.cityShippingDetails, GlobalVariable.city)

WebUI.verifyEqual(GlobalVariable.addressShippingDetail, GlobalVariable.addres)

WebUI.verifyEqual(GlobalVariable.postalCodeShippingDetail, GlobalVariable.postalCode)
