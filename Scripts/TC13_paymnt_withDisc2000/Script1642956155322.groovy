...
WebUI.click(findTestObject('credit_debitCard/inputRow_promoMidtrans2000'))
...
WebUI.verifyElementPresent(findTestObject('credit_debitCard/notif_promoIsNotAvailable'), 0)
